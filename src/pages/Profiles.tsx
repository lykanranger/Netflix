    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center p-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-4xl">
        {profiles.map((profile, index) => (
          ...
          >
            <div className={`w-32 h-32 rounded-lg ${AVATAR_COLORS[index % AVATAR_COLORS.length]} flex items-center justify-center group-hover:ring-4 group-hover:ring-white transition-all`}>
